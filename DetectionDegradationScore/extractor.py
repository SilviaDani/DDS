...
class FasterRCNNMobileNetV3LargeFPNFeatureExtractor(FeatureExtractor):
    """
    Feature extractor for FasterRCNN with MobileNetV3-Large-FPN backbone.
    """
...
def load_feature_extractor(
    ...
    elif backbone_name == Backbone.FASTERRCNN_MOBILENET_V3_LARGE_FPN:
        return FasterRCNNMobileNetV3LargeFPNFeatureExtractor()
    else:
        raise ValueError(
