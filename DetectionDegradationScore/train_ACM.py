...
# --- CUSTOM IMPORTS ---
# Assumes ddsrn_agnostic_ACM.py contains the SpatialDDSRN / create_agnostic_model
from ddsrn_agnostic_ACM import create_agnostic_model 
from dataloader_ACM import create_dynamic_dataloader 
...
class Trainer:
    ...
    def save_test_metrics_to_csv(self, pearson_corr: float, spearman_corr: float, mae: float) -> None:
        ...
        metrics_data = {
            'metric': ['pearson_correlation', 'spearman_correlation', 'mae', 'num_samples', 'attempt', 'backbone', 'timestamp'],
            'value': [
    ...
    **kwargs
    ...
    def make_loader(split_name, bs, determ, shuffle, drop_last):
        ...
        return create_dynamic_dataloader(
            ...
            generate_heatmaps_from_detector=True, 
...
def main():
    ...
    BACKBONE_REF = Backbone.YOLO_V11_M 
