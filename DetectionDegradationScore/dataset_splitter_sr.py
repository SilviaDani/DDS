...
class DatasetOrganizer:
    ...
    def copy_image(
        self, img_name: str, source_split: str, target_split: str
    ):
        """
        ...
        # Copy compressed image (assumed default compressed folder without quality info)
        src_compressed = self.unbalanced_path / source_split / "compressed" / img_name
    ...
    def organize_dataset(self):
        ...
        for target_split, items in self.split_info.items():
            ...
            for img_name in items.keys():
                source_split = target_split

                success = self.copy_image(img_name, source_split, target_split)
                total_processed += 1
...
if __name__ == "__main__":
    ...
    UNBALANCED_DIR = "unbalanced_dataset_sr"
    BALANCED_DIR = "balanced_dataset_sr"
