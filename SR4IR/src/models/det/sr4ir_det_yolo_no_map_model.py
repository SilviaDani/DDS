...
class SR4IRDetectionModel(BaseModel):
    def __init__(self, opt):
        ...
        if self.opt['test'].get('visualize', False):
            self.yolo_vis_dir = osp.join(self.vis_dir, 'visualization_output_visdrone/visualize_yolo')
            self.rtdetr_vis_dir = osp.join(self.vis_dir, 'visualization_output_visdrone/visualize_rtdetr')
